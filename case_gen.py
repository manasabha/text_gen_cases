...
def create_word_list(path):
    ...
    with open(path) as f:
        for line in tqdm(f):
            ...
            words = list(map(lambda x: x.lower().translate(None, string.punctuation).translate(None, string.digits), line.strip().split()))
...
if __name__ == "__main__":
    ...
    # save the model
    model.save(save_model_dir + "/" + 'my_model_generate_sentences.h5')
